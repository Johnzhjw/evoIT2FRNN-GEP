...
void allocateMemory()
{
    ...
    st_PSO_p.w = allocDouble(st_global_p.the_size_IND);
    st_PSO_p.c1 = allocDouble(st_global_p.the_size_IND);
    st_PSO_p.c2 = allocDouble(st_global_p.the_size_IND);
    ...
    st_DE_p.Fall_SHADE = allocDouble(st_global_p.nInd_1pop);
    st_DE_p.CRall_SHADE = allocDouble(st_global_p.nInd_1pop);
    st_DE_p.Fall_JADE = allocDouble(st_global_p.nInd_1pop);
    st_DE_p.CRall_JADE = allocDouble(st_global_p.nInd_1pop);
    st_DE_p.CRall_evo = allocDouble(st_global_p.nInd_1pop);
    st_DE_p.Fall_jDE = allocDouble(st_global_p.nInd_1pop);
    st_DE_p.CRall_jDE = allocDouble(st_global_p.nInd_1pop);
    st_DE_p.Fall_NSDE = allocDouble(st_global_p.nInd_1pop);
    st_DE_p.CRall_NSDE = allocDouble(st_global_p.nInd_1pop);
    st_DE_p.Fall_SaNSDE = allocDouble(st_global_p.nInd_1pop);
    st_DE_p.CRall_SaNSDE = allocDouble(st_global_p.nInd_1pop);
    ...
    st_optimizer_p.rate_Commonality = allocDouble(st_global_p.nDim);
...
void freeMemory()
{
    ...
    free(st_DE_p.Fall_SHADE);
    free(st_DE_p.CRall_SHADE);
    free(st_DE_p.Fall_JADE);
    free(st_DE_p.CRall_JADE);
    free(st_DE_p.CRall_evo);
    free(st_DE_p.Fall_jDE);
    free(st_DE_p.CRall_jDE);
    free(st_DE_p.Fall_NSDE);
    free(st_DE_p.CRall_NSDE);
    free(st_DE_p.Fall_SaNSDE);
    free(st_DE_p.CRall_SaNSDE);
    free(st_DE_p.Sflag);
